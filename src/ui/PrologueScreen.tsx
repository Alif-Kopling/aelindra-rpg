...
const PROLOGUE_CINEMATIC: CinematicLine[] = [
  // 1. CASTLE_DIALOGUE_INTRO — Di Kastel (sebelum tragedi)
  {
    ...
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Baginda... patroli timur lapor liat cahaya aneh di dekat segel kuno. Aku minta izin nyelidikin.',
    emotion: 'determined',
  },
  {
    image: 'scene1-before-tragedy.jpeg',
    speaker: 'King Aldric',
    portrait: 'king',
    text: 'Alden... pedang paling aku percaya. Aku rasa sesuatu bergerak di kegelapan lama. Tapi malam ini — deket-deket aku. Aku nggak enak.',
    emotion: 'sad',
  },
  {
  ...
  },
  {
    ...
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Aku jagain raja dengan nyawaku, Putri. Dan aku lindungin kamu juga.',
    emotion: 'determined',
  },
  {
    image: 'Scene2-evelyn-and-mc.png',
    speaker: 'King Aldric',
    portrait: 'king',
    text: '...Kamu selalu gitu, nak. Makanya aku percaya kamu di atas yang lain.',
    emotion: 'sad',
  },
  ...
  },
  {
    ...
    speaker: 'Valther',
    portrait: 'valther',
    text: 'TANGKAP DIA! Ksatria Alden udah bunuh raja kita! Aku liat sendiri!',
    emotion: 'angry',
  },
  {
    image: 'scene3-The-Tragedy.jpeg',
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Apa— Nggak! Aku nemuin dia kayak gini! Valther, kamu TAU aku nggak bakal—',
    emotion: 'shocked',
  },
  {
    image: 'scene3-The-Tragedy.jpeg',
    speaker: 'Valther',
    portrait: 'valther',
    text: 'Pedangnya di tangan kamu, pengkhianat. Nggak ada yang perlu dibahas lagi.',
    emotion: 'neutral',
  },
  {
    ...
    speaker: 'Princess Evelyne',
    portrait: 'evelyne',
    text: '...Kamu... Kamu bunuh dia. Kamu bunuh ayah aku.',
    emotion: 'sad',
  },
  {
    image: 'scene4-evelyn-marah-kepada-mc.png',
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Putri, tolong— aku sumpah demi apapun yang aku punya—',
    emotion: 'sad',
  },
  {
    image: 'scene4-evelyn-marah-kepada-mc.png',
    speaker: 'Princess Evelyne',
    portrait: 'evelyne',
    text: 'Bawa dia pergi. Aku nggak sanggup liat dia.',
    emotion: 'angry',
  },
  ...
  },
  {
    ...
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Dikhianati... sama kerajaan yang aku sumpah buat lindungin. Segini akhirnya?',
    emotion: 'sad',
  },
  {
  ...
  },
  {
    ...
    speaker: 'Old Edric',
    portrait: 'blacksmith',
    text: 'Kamu nggak ngelakuin itu. Tau ini tulang-tulang tua aku. Sekarang LARI, nak. Lari dan cari kebenaran.',
    emotion: 'determined',
  },
  {
    image: 'scene6-mc-diselamatkan-oleh-seseorang.jpeg',
