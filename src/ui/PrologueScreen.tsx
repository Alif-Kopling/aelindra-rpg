...
const PROLOGUE_CINEMATIC: CinematicLine[] = [
  // 1. CASTLE_DIALOGUE_INTRO — Di Kastel (sebelum tragedi)
  {
    ...
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Your Majesty... the eastern patrols reported strange lights near the ancient seals. I ask permission to investigate.',
    emotion: 'determined',
  },
  {
    image: 'scene1-before-tragedy.jpeg',
    speaker: 'King Aldric',
    portrait: 'king',
    text: 'Alden... my most trusted blade. I fear something stirs in the old dark. But tonight — stay close. I am uneasy.',
    emotion: 'sad',
  },
  {
    ...
    portrait: 'evelyne',
    text: 'Alden, please... listen to my father. Do not go chasing shadows in the dark tonight.',
    emotion: 'sad',
  },
  {
    image: 'Scene2-evelyn-and-mc.jpeg',
    speaker: 'Alden',
    portrait: 'alden',
    text: 'I will guard the king with my life, Princess. And I will protect you.',
    emotion: 'determined',
  },
  {
    image: 'Scene2-evelyn-and-mc.jpeg',
    speaker: 'King Aldric',
    portrait: 'king',
    text: '...You always have, my boy. That is why I trust you above all others.',
    emotion: 'sad',
  },
  // 2. BETRAYAL_SCENE — Malam Pembunuhan
  {
    ...
    speaker: '— Narrator —',
    text: 'Three hours later. A scream tears through the castle walls.',
    isNarration: true,
    emotion: 'shocked',
  },
  {
    ...
    speaker: 'Valther',
    portrait: 'valther',
    text: 'SEIZE HIM! The knight Alden has murdered our king! I witnessed it myself!',
    emotion: 'angry',
  },
  {
    image: 'scene3-The-Tragedy.jpeg',
    speaker: 'Alden',
    portrait: 'alden',
    text: 'What— No! I found him like this! Valther, you KNOW I would never—',
    emotion: 'shocked',
  },
  {
    image: 'scene3-The-Tragedy.jpeg',
    speaker: 'Valther',
    portrait: 'valther',
    text: 'The blade is in your hand, traitor. There is nothing more to say.',
    emotion: 'neutral',
  },
  {
    image: 'scene4-evelyn-marah-kepada-mc.jpeg',
    speaker: 'Princess Evelyne',
    portrait: 'evelyne',
    text: '...You... You killed him. You killed my father.',
    emotion: 'sad',
  },
  {
    image: 'scene4-evelyn-marah-kepada-mc.jpeg',
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Your Highness, please— I swear on everything I am—',
    emotion: 'sad',
  },
  {
    image: 'scene4-evelyn-marah-kepada-mc.jpeg',
    speaker: 'Princess Evelyne',
    portrait: 'evelyne',
    text: 'Take him away. I cannot look at him.',
    emotion: 'angry',
  },
  // 3. ESCAPE_NARRATION — Edric Membebaskan Alden
  {
    ...
    speaker: '— Narrator —',
    text: 'They dragged him to the cold, damp dungeons, awaiting execution at dawn.',
    isNarration: true,
    emotion: 'sad',
  },
  {
    ...
    speaker: 'Alden',
    portrait: 'alden',
    text: 'Betrayed... by the kingdom I swore to protect. Is this how it ends?',
    emotion: 'sad',
  },
  {
    image: 'scene6-mc-diselamatkan-oleh-seseorang.jpeg',
    speaker: '— Narrator —',
    text: 'But in the darkest hour, a heavy footstep approached. Edric, the royal blacksmith — the one man who still believed.',
    isNarration: true,
    emotion: 'neutral',
  },
  {
    ...
    speaker: 'Old Edric',
    portrait: 'blacksmith',
    text: 'You didn\'t do it. I know it in these old bones. Now RUN, boy. Run and find the truth.',
    emotion: 'determined',
  },
  {
    image: 'scene6-mc-diselamatkan-oleh-seseorang.jpeg',
  ...
  },
  {
    ...
    speaker: 'Old Edric',
    portrait: 'blacksmith',
    text: 'Don\'t you dare cry. Not yet. Survive first. Then grieve.',
    emotion: 'determined',
  },
  ...
  },
  {
    image: 'last-scene-mc-kabur-dari-penjara.jpeg',
    speaker: '— Narrator —',
    text: 'Hunted by those he once called brothers, Alden flees into the rainy night. His only path forward is through the darkness.',
    isNarration: true,
    emotion: 'determined',
  },
];
